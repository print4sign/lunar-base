...
use Lunar\Scraper\Admin\Forms\Components\TranslatedRepeaterField;
use Lunar\Scraper\Admin\Synthesizers\TranslatedRepeaterSynth;
use Lunar\Scraper\FieldTypes\TranslatedRepeaterFieldValue;

/**
 * A configurable translated repeater field type.
 */
class TranslatedRepeaterFieldType extends BaseFieldType
{
    ...
    public static function getFilamentComponent(Attribute $attribute): Component
    {
        ...
        $component = TranslatedRepeaterField::make($attribute->handle)
            ->fieldType(TranslatedRepeaterFieldValue::class)
            ->statePath($attribute->handle)
            ->repeaterSchema($schema)
